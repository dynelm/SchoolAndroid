...
public class VideoActivity extends BasicActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        container = (FrameLayout) findViewById(R.id.local_video_view_container);
        container1 = (FrameLayout) findViewById(R.id.remote_video_view_container);
    ...
    private void joinChannel() {
        mRtcEngine.joinChannel(null, "1000", "Extra Optional Data", 0); // if you do not specify the uid, we will generate the uid for you
    }
